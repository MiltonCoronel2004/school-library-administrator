  ...
  <a class="btn btn-warning w-60 mb-3 mb-sm-0" href="generar/generar.php">Nuevo Movimiento</a>
      ...
      <div class="table-responsive custom-table-responsive mt-4 table-wrapper">
        ...
        <table class="table custom-table text-center">
          ...
          <?php
         $consulta = "SELECT *, DATE_FORMAT(fecha, '%d/%m/%Y %H:%i') AS fecha_formateada FROM movimientoslibros ORDER BY fecha_formateada DESC";
         ...
         $resultado = mysqli_query($connection, $consulta);
          ...
          if(mysqli_num_rows($resultado) > 0) {
              ...
              while($fila = mysqli_fetch_assoc($resultado)) {
                ...
                echo "<td style='max-width: 150px; word-break: break-word;'>" . $fila['libros'] . "</td>";
                echo "<td style='max-width: 150px; word-break: break-word;'>" . $fila['curso'] . "</td>";
                echo "<td style='max-width: 150px; word-break: break-word;'>" . $fila['responsable'] . "</td>";
                echo "<td style='max-width: 150px; word-break: break-word;'>" . $fila['profesor'] . "</td>";
  ...
  $(document).ready(function() {
    $('.fila-tabla').on('dblclick', function() {
      ...
      if (devuelto === 'No') {
        ...
        var confirmar = confirm("¿Desea finalizar el movimiento? Sin vuelta atras");
...
<script>
$(document).ready(function() {
  $('.table-wrapper').on("mousedown", function(event) {
