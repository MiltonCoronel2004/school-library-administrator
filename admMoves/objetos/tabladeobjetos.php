  ...
  <a class="btn btn-warning w-60 mb-3 mb-sm-0" href="generar/generar.php">Nuevo Movimiento</a>
      ...
      <div class="table-responsive custom-table-responsive mt-4 table-wrapper">
        ...
        <table class="table custom-table text-center">
          ...
          <?php
         $consulta = "SELECT *, DATE_FORMAT(fecha, '%d/%m/%Y %H:%i') AS fecha_formateada FROM movimientos_objetos ORDER BY fecha_formateada DESC";
         ...
         $resultado = mysqli_query($connection, $consulta);
          ...
          if(mysqli_num_rows($resultado) > 0) {
              ...
              while($fila = mysqli_fetch_assoc($resultado)) {
                ...
                echo "<td style='max-width: 150px; word-break: break-word;'>" . $fila['objeto'] . "</td>";
