...
<head>
    ...
    <title>Movimientos de Libros</title>
    <link rel="icon" href="../../../img/logo.png" type="image/png">
</head>
<body>
    ...
    <div class="cotainer">
        <nav class="navbar navbar-expand-lg navbar-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="../../../admLibros/objeto.php">Libros</a>
                </li>
                <li class="nav-item">
...
<div class="card bg-dark text-light p-4">
  <h2 class="text-center mb-4">Movimiento de Objetos</h2>
  ...
  <div class="row">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" id="profesor" name="profesor" class="form-control mb-4" required>
        </div>
      </div>
      <div class="col-md-6">
      <div class="form-group">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="text" id="observaciones" name="observaciones" class="form-control mb-4" required max="9999-12-31T00:00">
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="form-group">
          <label for="ids">ID(s) de Objeto(s):</label>
          <input type="text" id="ids" name="ids" class="form-control mb-4" required oninput="sanitizeInput(this)" onkeydown="preventSpaces(event)">
        </div>
      </div>
    </div>
