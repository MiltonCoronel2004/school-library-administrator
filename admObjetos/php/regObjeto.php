...
<head>
    ...
    <meta objeto="viewport" content="width=device-width, initial-scale=1.0">
...
if (isset($_POST['registrar'])) {
  ...
  $consulta = "SELECT * FROM tabladeobjetos WHERE objeto='$objeto'";
  ...
  <?php   
    ...
    $insertar_datos = "INSERT INTO tabladeobjetos (objeto, observaciones, existencias) VALUES ('$objeto','$observaciones','$existencias')";
    $resultado = mysqli_query($connection, $insertar_datos);

    $consulta = "SELECT * FROM tabladeobjetos";
